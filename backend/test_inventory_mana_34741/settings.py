"""
Django settings for test_inventory_mana_34741 project.
...
ROOT_URLCONF = 'test_inventory_mana_34741.urls'
...
WSGI_APPLICATION = 'test_inventory_mana_34741.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_inventory_mana_34741 API",
    "DESCRIPTION": "API documentation for test_inventory_mana_34741 App",
    "VERSION": "v1",
}
