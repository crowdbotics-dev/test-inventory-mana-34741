...
## Project Structure
    ...
    ├── test_inventory_mana_34741  # Django project configurations
...
1. Clone this repo and `cd test_inventory_mana_34741`
...
2. Clone this repo and `cd test_inventory_mana_34741`
